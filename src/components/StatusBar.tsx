    ...
    <footer className="ev-statusbar">
      <div className="ev-statusbar__left">
        {buildStatus && buildStatus !== 'idle' && (
          <span className={`ev-statusbar__indicator ev-statusbar__indicator--${buildStatus}`}>
        ...
        {deployStatus && deployStatus !== 'idle' && (
          <span className={`ev-statusbar__indicator ev-statusbar__indicator--${deployStatus === 'deploying' ? 'building' : deployStatus}`}>
      ...
      <div className="ev-statusbar__right">
        ...
        <span className="ev-statusbar__item ev-statusbar__item--dim">
          v0.1.0
        </span>
      </div>
    </footer>
